...
const en: Dict = {
  ...
  "nav.about": "About",
  "nav.admin": "Admin",
  "hero.subtitle": "A place of worship, learning & community.",
  ...
  "prayer.lastUpdated": "Last updated",
...
const te: Dict = {
  ...
  "nav.admin": "అడ్మిన్",
  "hero.subtitle": "ఆరాధన, విద్య & సమాజం కోసం ఒక ప్రదేశం.",
  ...
  "prayer.lastUpdated": "చివరి నవీకరణ",
...
const ur: Dict = {
  ...
  "nav.about": "تعارف",
  "nav.admin": "ایڈمن",
  "hero.subtitle": "عبادت، علم اور برادری کی جگہ۔",
  ...
  "prayer.lastUpdated": "آخری اپ ڈیٹ",
  ...
  "quran.search": "پی ڈی ایف میں تلاش کریں",
  "quran.searchPlaceholder": "لفظ یا جملہ تلاش کریں",
  "quran.fullscreen": "فل اسکرین",
