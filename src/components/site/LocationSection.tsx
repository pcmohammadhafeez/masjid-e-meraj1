...
export function LocationSection() {
  ...
  return (
    <Reveal as="article" className="h-full" delay={180}>
      <div id="location" className="surface-card h-full scroll-mt-24 rounded-[2rem] p-7">
        ...
        <p className="mt-5 text-base font-semibold text-foreground">{name}</p>
        <p className="mt-1 text-sm leading-relaxed text-muted-foreground">{address}</p>

        <div className="mt-5 overflow-hidden rounded-2xl border border-gold/30">
          <iframe
            src={embed}
